...
// shows -- is written by hand and never touched here; this only rewrites the
// block between the GENERATED markers. So adding a recording means writing its
// file first (copy an existing one, keep the markers, empty the block) and then
// running this to fill it in.
//
